 ...
 * Should work as a drop in replacement for the original one.
 * The implementation is able to keep state between calls: so inserting rows through
 * {@link SnowflakeStreamingIngestChannel#insertRow} will update the {@link SnowflakeStreamingIngestChannel#getLatestCommittedOffsetToken()}.
 *
 * The only method that does is not supported is {@link SnowflakeStreamingIngestChannel#getTableSchema}
 */
