...
public class IcebergIngestionSchemaEvolutionIT extends IcebergIngestionIT {
  ...
  private static final String RECORD_METADATA_TYPE =
      "OBJECT(offset NUMBER(10,0), topic STRING, partition NUMBER(10,0), key"
          + " STRING, schema_id NUMBER(10,0), key_schema_id NUMBER(10,0),"
          + " CreateTime NUMBER(19,0), LogAppendTime NUMBER(19,0),"
          + " SnowflakeConnectorPushTime NUMBER(19,0), headers MAP(STRING,"
          + " STRING))";
  ...
  void shouldEvolveSchemaAndInsertRecords(
    ...
    rows = describeTable(tableName);
    assertThat(rows).hasSize(10).contains(new DescribeTableRow("SIMPLE", "STRING"));
    ...
    return Stream.of(
        Arguments.of(
            ...
            new DescribeTableRow[] {
              ...
              new DescribeTableRow("DESCRIPTION", "STRING"),
  ...
  public void alterStructure_noSchema() throws Exception {
    ...
    assertEquals(
        columns.get(1).getType(), "OBJECT(k1 NUMBER(19,0), k2 NUMBER(19,0), k3 STRING, k4 FLOAT)");
    ...
    assertEquals(
        ...
        "OBJECT(k1 NUMBER(19,0), k2 NUMBER(19,0), k3 STRING, k4 FLOAT, k5 NUMBER(19,0),"
            + " k6 NUMBER(19,0))");
  ...
  public void testComplexRecordEvolution_withSchema() throws Exception {
    ...
    DescribeTableRow[] expectedSchema =
        new DescribeTableRow[] {
          ...
          new DescribeTableRow("ARRAY2", "ARRAY(STRING)"),
          ...
          new DescribeTableRow(
              ...
              "OBJECT(id_int8 NUMBER(10,0), id_int16 NUMBER(10,0), id_int32 NUMBER(10,0), id_int64"
                  + " NUMBER(19,0), description STRING, rating_float32 FLOAT,"
  ...
  private static Stream<Arguments> schemasAndPayloads_brandNewColumns() {
    return Stream.of(
        Arguments.of(
            ...
            "OBJECT(nestedStruct OBJECT(description STRING))"),
        Arguments.of(simpleMapWithSchema(), "SIMPLE_TEST_MAP", "MAP(STRING, NUMBER(10,0))"),
        Arguments.of(simpleArrayWithSchema(), "SIMPLE_ARRAY", "ARRAY(NUMBER(10,0))"),
        Arguments.of(
            complexPayloadWithSchema(), "OBJECT", "OBJECT(arrayOfMaps ARRAY(MAP(STRING, FLOAT)))"));
  }
  ...
  public void testEvolutionOfPrimitives_withSchema(
    ...
    expectedSchema =
        new DescribeTableRow[] {
          ...
          new DescribeTableRow("TEST_INT32", SMALL_INT),
          new DescribeTableRow("TEST_INT64", "NUMBER(19,0)"),
          new DescribeTableRow("TEST_STRING", "STRING"),
  ...
  public void testEvolutionOfComplexTypes_withSchema(
    ...
    assertEquals("OBJECT(test_string STRING)", columns.get(1).getType());
    ...
    assertEquals("OBJECT", columns.get(1).getColumn());
    assertEquals(
        "OBJECT(test_string STRING, nested_object OBJECT(test_string" + " STRING))",
        columns.get(1).getType());
    ...
    assertEquals("OBJECT(nestedStruct OBJECT(description STRING))", columns.get(2).getType());
    ...
    if (withSchema) {
      ...
      assertEquals(
          "OBJECT(test_string STRING, nested_object OBJECT(test_string"
              + " STRING), Test_Map MAP(STRING, OBJECT(test_string"
              + " STRING)))",
          columns.get(1).getType());
    }
    // 2nd column
    assertEquals("OBJECT_WITH_NESTED_OBJECTS", columns.get(2).getColumn());
    assertEquals(
        "OBJECT(nestedStruct OBJECT(description STRING, test_array ARRAY(FLOAT)))",
