...
public class SnowflakeSinkServiceV2IT {
    ...
    Assert.assertTrue(
        snowflakeSinkServiceV2
            .getTopicPartitionChannelFromCacheKey(
                partitionChannelKey(TEST_CONNECTOR_NAME, tp2.topic(), tp2.partition(), this.shouldUseConnectorNameInChannelName))
            .isPresent());
  ...
  public void testStreamingIngest_multipleChannelPartitions_withMetrics() throws Exception {
    ...
    this.verifyPartitionMetrics(
        metricRegistry,
        partitionChannelKey(TEST_CONNECTOR_NAME, topic, partition, this.shouldUseConnectorNameInChannelName),
    ...
    this.verifyPartitionMetrics(
        metricRegistry,
        partitionChannelKey(TEST_CONNECTOR_NAME, topic, partition2, this.shouldUseConnectorNameInChannelName),
        NO_OFFSET_TOKEN_REGISTERED_IN_SNOWFLAKE,
