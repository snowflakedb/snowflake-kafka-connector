...
public class StreamingClientProviderIT {
  ...
  public void testGetMultipleClients() throws Exception {
    ...
    validRegisteredClientConfig.put(Utils.SF_ROLE, "testrole_kafka");
    ...
    invalidRegisteredClientConfig.put(Utils.SF_ROLE, "testrole_kafka_1");
    ...
    validUnregisteredClientConfig.put(Utils.SF_ROLE, "public");
