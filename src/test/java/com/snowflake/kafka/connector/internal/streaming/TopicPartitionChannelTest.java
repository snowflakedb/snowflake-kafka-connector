...
//
//  @Mock private KcStreamingIngestClient mockStreamingIngestKcStreamingIngestClient;
//
...
//    mockStreamingIngestKcStreamingIngestClient = Mockito.mock(KcStreamingIngestClient.class);
...
//    Mockito.when(mockStreamingIngestKcStreamingIngestClient.getStreamingIngestClient(0))
//        .thenReturn(mockStreamingClient);
//    IngestSdkProvider.clientManager = mockStreamingIngestKcStreamingIngestClient;
