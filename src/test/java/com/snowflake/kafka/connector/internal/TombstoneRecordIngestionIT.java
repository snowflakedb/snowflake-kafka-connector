...
public class TombstoneRecordIngestionIT {
  ...
  public static Collection<Object[]> input() {
    return Arrays.asList(new Object[][] {
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CustomSfConverter.JSON_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CustomSfConverter.AVRO_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CustomSfConverter.AVRO_CONVERTER_WITHOUT_SCHEMA_REGISTRY.converter},
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CommunityConverterSubset.JSON_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CommunityConverterSubset.AVRO_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CommunityConverterSubset.STRING_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CommunityConverterSubset.JSON_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE, ConnectorConfigTest.CommunityConverterSubset.AVRO_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE_STREAMING, ConnectorConfigTest.CommunityConverterSubset.STRING_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE_STREAMING, ConnectorConfigTest.CommunityConverterSubset.JSON_CONVERTER.converter},
        {IngestionMethodConfig.SNOWPIPE_STREAMING, ConnectorConfigTest.CommunityConverterSubset.AVRO_CONVERTER.converter}
    });
  }
  ...
  public void testIgnoreTombstoneRecordBehavior() throws Exception {
    ...
    SinkRecord record1 =
        new SinkRecord(
            topic, partition, Schema.STRING_SCHEMA, "test", record1Input.schema(), record1Input.value(), record1Offset);

    // make normal record
    SchemaAndValue record2Input = converter.toConnectData(topic, "{\"name\":\"test\"}".getBytes(StandardCharsets.UTF_8));
    long record2Offset = 1;
    SinkRecord record2 =
        new SinkRecord(
            topic, partition, Schema.STRING_SCHEMA, "test", record2Input.schema(), record2Input.value(), record2Offset);
...
//    SinkRecord record1 =
//        new SinkRecord(
//            topic, partition0, Schema.STRING_SCHEMA, "test", input.schema(), input.value(), offset);
//    service.insert(Collections.singletonList(record1));
//    TestUtils.assertWithRetry(
//        () ->
//            conn.listStage(
