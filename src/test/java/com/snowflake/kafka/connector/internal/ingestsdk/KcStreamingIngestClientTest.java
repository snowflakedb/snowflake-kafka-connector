...
//    this.clientName = KcStreamingIngestClient.buildStreamingIngestClientName(this.kcInstanceId, 0);
//
//    // config
...
//
//    // test creation
//    KcStreamingIngestClient kcStreamingIngestClient = new KcStreamingIngestClient();
//    kcStreamingIngestClient.createAllStreamingClients(this.config, this.kcInstanceId, this.clientTaskMap);
//
//    // test get
//    SnowflakeStreamingIngestClient createdClient = kcStreamingIngestClient.getStreamingIngestClient(taskList.get(0));
...
//
//    // test
//    KcStreamingIngestClient kcStreamingIngestClient = new KcStreamingIngestClient(this.clientTaskMap, 1);
//    kcStreamingIngestClient.closeAllStreamingClients();
//
...
//    Mockito.doThrow(thrownException).when(this.mockClient).close();
//    kcStreamingIngestClient = new KcStreamingIngestClient(this.clientTaskMap, 1);
//    kcStreamingIngestClient.closeAllStreamingClients();
//
