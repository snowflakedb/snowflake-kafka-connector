 ...
 */
 ...
 public class StreamingClientHandlerTest {
     ...
     public void testCreateClient() {
         SnowflakeStreamingIngestClient client = this.streamingClientHandler.createClient(this.connectorConfig);
  ...
  public void testCloseClientWithVariousExceptions() throws Exception {
    ...
    Mockito.verify(streamingIngestClient, Mockito.times(2)).getName();
     ...
     public void testIsClientValid() {
         ...
         SnowflakeStreamingIngestClient closedClient = Mockito.mock(SnowflakeStreamingIngestClient.class);
         ...
         SnowflakeStreamingIngestClient unnamedClient = Mockito.mock(SnowflakeStreamingIngestClient.class);
