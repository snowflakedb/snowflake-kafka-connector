...
//
//  @Test
//  public void testMultipleGetClient() {
//    // setup
//    String connectorName = connectorConfig.get(Utils.NAME);
//    SnowflakeStreamingIngestClient streamingIngestClient =
//        Mockito.mock(SnowflakeStreamingIngestClient.class);
//    StreamingClientProvider injectedProvider =
//        injectStreamingClientProviderForTests(null, streamingIngestClient);
//
//    // test getting another client
//    SnowflakeStreamingIngestClient firstGetClient = injectedProvider.getClient(connectorConfig);
//    SnowflakeStreamingIngestClient secondGetClient = injectedProvider.getClient(connectorConfig);
//
//    // verify
//    assert firstGetClient.getName().equals(secondGetClient.getName());
//    assert StreamingClientHandler.isClientValid(firstGetClient);
//  }
//
//  @Test
