...
public class FakeSnowflakeStreamingIngestClient implements SnowflakeStreamingIngestClient {
    ...
    private Set<FakeSnowflakeStreamingIngestChannel> openedChannels = new ConcurrentSkipListSet<>();
    private Map<String, String> channelNameToOffsetTokens = new ConcurrentHashMap<>();
    ...
    public OpenChannelResult openChannel(final String channelName, final String offsetToken) {
        ...
        final ChannelStatus channelStatus = new ChannelStatus("db","schema",pipeName,channelName,"SUCCESS", offsetToken, Instant.now(), 1,1,1, null, null, null,null, Instant.now());
