...
public class StreamingClientProviderConcurrencyTest {
  ...
  private FakeStreamingClientHandler streamingClientHandler;
  ...
  public StreamingClientProviderConcurrencyTest(boolean enableClientOptimization) {
  ...
  public void setup() {
    ...
    this.streamingClientHandler = new FakeStreamingClientHandler();
