...
public class SnowflakeSinkTaskTest {
    ...
    public void testMultipleSinkTaskWithLogs() throws Exception {
        ...
        List<TopicPartition> topicPartitions0 = SnowflakeSinkTaskTestForStreamingIT.getTopicPartitions(topicName0, 1);
        ...
        List<TopicPartition> topicPartitions1 = SnowflakeSinkTaskTestForStreamingIT.getTopicPartitions(topicName1, 1);
        ...
        IngestSdkProvider.getStreamingClientManager()
                .createAllStreamingClients(config0, "kcid", 2, 1);
