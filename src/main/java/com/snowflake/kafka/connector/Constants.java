...
public final class Constants {
  ...
  public static final class KafkaConnectorConfigParams {
    ...
    public static final String SNOWFLAKE_ENABLE_QUOTED_IDENTIFIERS =
        "snowflake.enable.quoted.identifiers";
    public static final boolean SNOWFLAKE_ENABLE_QUOTED_IDENTIFIERS_DEFAULT = false;
    // MDC logging header
