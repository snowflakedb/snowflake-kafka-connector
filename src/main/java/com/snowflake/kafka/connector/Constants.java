  ...
  public static final class KafkaConnectorConfigParams {
    ...
    public static final String
        SNOWFLAKE_COMPATIBILITY_ENABLE_AUTOGENERATED_TABLE_NAME_SANITIZATION_HASH =
            "snowflake.compatibility.enable.autogenerated.table.name.sanitization.hash";
    public static final boolean
        SNOWFLAKE_COMPATIBILITY_ENABLE_AUTOGENERATED_TABLE_NAME_SANITIZATION_HASH_DEFAULT = true;
