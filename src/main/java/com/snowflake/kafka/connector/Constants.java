...
public final class Constants {
  ...
  public static final class KafkaConnectorConfigParams {
    ...
    public static final String SNOWFLAKE_ENABLE_QUOTED_IDENTIFIERS_FOR_AUTOGENERATED =
        "snowflake.enable.quoted.identifiers.for.autogenerated";
    public static final boolean SNOWFLAKE_ENABLE_QUOTED_IDENTIFIERS_FOR_AUTOGENERATED_DEFAULT =
        false;
    // MDC logging header
