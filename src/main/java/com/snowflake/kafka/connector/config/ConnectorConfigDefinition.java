...
public class ConnectorConfigDefinition {
  ...
  public static ConfigDef getConfig() {
    return new ConfigDef()
        ...
        .define(
            KafkaConnectorConfigParams
                .SNOWFLAKE_COMPATIBILITY_ENABLE_AUTOGENERATED_TABLE_NAME_SANITIZATION_HASH,
            BOOLEAN,
            KafkaConnectorConfigParams
                .SNOWFLAKE_COMPATIBILITY_ENABLE_AUTOGENERATED_TABLE_NAME_SANITIZATION_HASH_DEFAULT,
            LOW,
            "When enabled (default), appends a disambiguating hash to sanitized table names."
                + " Only applies when table name sanitization is enabled. When disabled, distinct"
                + " topics that sanitize to the same name collide into one table.",
            CONNECTOR_CONFIG_DOC,
            9,
            Width.NONE,
            KafkaConnectorConfigParams
