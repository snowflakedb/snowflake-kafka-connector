...
public abstract class SinkTaskConfig {
  ...
  public abstract boolean isEnableTableNameHash();
  ...
  public static Builder builderFrom(Map<String, String> raw, boolean skipTaskSpecificConfig) {
    ...
    b.connectorName(connectorName)
        ...
        .enableTableNameHash(enableTableNameHash)
  ...
  public abstract static class Builder {
    ...
    public abstract Builder enableTableNameHash(boolean enableTableNameHash);
