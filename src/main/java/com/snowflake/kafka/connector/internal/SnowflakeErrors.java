...
public enum SnowflakeErrors {
  ...
  ERROR_3010("3010", "Invalid task id(s)", "Task id(s) was not correctly mapped to a streaming ingest client"),
  ERROR_3011("3011", "Invalid client task map parameters", "Given task count or ratio should be above 0"),
