...
public enum SnowflakeErrors {
  ...
  ERROR_5016(
      "5016",
      "Invalid SinkRecord received",
      "SinkRecord.value and SinkRecord.valueSchema cannot be null unless tombstone record ingestion is enabled (see " + SnowflakeSinkConnectorConfig.BEHAVIOR_ON_NULL_VALUES_CONFIG + " for more information."),
  ERROR_5017(
