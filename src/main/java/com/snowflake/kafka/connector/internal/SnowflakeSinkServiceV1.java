...
class SnowflakeSinkServiceV1 extends Logging implements SnowflakeSinkService {
  ...
  private class ServiceContext {
    ...
    // Used for time based flush which depends on system time and not on record time.
    // Initialised during partition assignment.
    // It is reset when we flush the file.
    // This is system wall clock based flush
