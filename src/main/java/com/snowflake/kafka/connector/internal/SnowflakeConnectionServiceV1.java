...
public class SnowflakeConnectionServiceV1 implements SnowflakeConnectionService {
  ...
  SnowflakeConnectionServiceV1(
    ...
    this.telemetry =
        SnowflakeTelemetryServiceFactory.builder(conn)
            ...
            .build();
    LOGGER.LOG_INFO_MSG("initialized the snowflake connection");
  }
  ...
  public void createTable(final String tableName, final boolean overwrite) {
    ...
    LOGGER.LOG_INFO_MSG("create table {}", tableName);
  }
  ...
  public void createTableWithOnlyMetadataColumn(final String tableName) {
    ...
    LOGGER.LOG_INFO_MSG("Created table {} with only RECORD_METADATA column", tableName);
  }
  ...
  public void createPipe(
    ...
    LOGGER.LOG_INFO_MSG("create pipe: {}", pipeName);
  }
  ...
  public void createStage(final String stageName, final boolean overwrite) {
    ...
    LOGGER.LOG_INFO_MSG("create stage {}", stageName);
  }
  ...
  public boolean tableExist(final String tableName) {
    ...
    try {
      ...
      LOGGER.LOG_DEBUG_MSG("table {} doesn't exist", tableName);
      exist = false;
    } finally {
      if (stmt != null) {
        try {
  ...
  public boolean stageExist(final String stageName) {
    ...
    try {
      ...
      LOGGER.LOG_DEBUG_MSG("stage {} doesn't exists", stageName);
      exist = false;
    } finally {
      if (stmt != null) {
        try {
  ...
  public boolean pipeExist(final String pipeName) {
    ...
    try {
      ...
      LOGGER.LOG_DEBUG_MSG("pipe {} doesn't exist", pipeName);
      exist = false;
    } finally {
      if (stmt != null) {
        try {
  ...
  public void appendColumnsToTable(String tableName, Map<String, String> columnToType) {
    ...
    try {
      LOGGER.LOG_INFO_MSG("Trying to run query: {}", appendColumnQuery.toString());
    ...
    LOGGER.LOG_INFO_MSG(logColumn.toString(), tableName);
  }
  ...
  public void alterNonNullableColumns(String tableName, List<String> columnNames) {
    ...
    try {
      LOGGER.LOG_INFO_MSG("Trying to run query: {}", dropNotNullQuery.toString());
  ...
  public boolean isStageCompatible(final String stageName) {
    ...
    for (String name : files) {
      if (!FileNameUtils.verifyFileName(name)) {
        LOGGER.LOG_DEBUG_MSG("file name {} in stage {} is not valid", name, stageName);
        return false;
      }
    }
    return true;
  ...
  public boolean isPipeCompatible(
    ...
    try {
      ...
      if (!result.next()) {
        ...
        LOGGER.LOG_DEBUG_MSG("pipe {} definition: {}", pipeName, definition);
        compatible = definition.equalsIgnoreCase(pipeDefinition(tableName, stageName));
      }

    } catch (SQLException e) {
      LOGGER.LOG_DEBUG_MSG("pipe {} doesn't exists ", pipeName);
      compatible = false;
    } finally {
      try {
        if (stmt != null) {
  ...
  public void databaseExists(String databaseName) {
    ...
    LOGGER.LOG_INFO_MSG("database {} exists", databaseName);
  }
  ...
  public void schemaExists(String schemaName) {
    ...
    LOGGER.LOG_INFO_MSG("schema {} exists", schemaName);
  }
  ...
  public void dropPipe(final String pipeName) {
    ...
    LOGGER.LOG_INFO_MSG("pipe {} dropped", pipeName);
  }
  ...
  public boolean dropStageIfEmpty(final String stageName) {
    ...
    LOGGER.LOG_INFO_MSG("stage {} can't be dropped because it is not empty", stageName);
    return false;
  }
  ...
  public void dropStage(final String stageName) {
    ...
    LOGGER.LOG_INFO_MSG("stage {} dropped", stageName);
  }
  ...
  public void purgeStage(final String stageName, final List<String> files) {
    ...
    LOGGER.LOG_INFO_MSG("purge {} files from stage: {}", files.size(), stageName);
  }
  ...
  public List<String> listStage(
    ...
    LOGGER.LOG_INFO_MSG("list stage {} retrieved {} file names", stageName, result.size());
    return result;
  }
  ...
  public void put(final String stageName, final String fileName, final String content) {
    ...
    LOGGER.LOG_DEBUG_MSG("put file {} to stage {}", fileName, stageName);
  }
  ...
  public void putToTableStage(final String tableName, final String fileName, final byte[] content) {
    ...
    LOGGER.LOG_INFO_MSG("put file: {} to table stage: {}", fileName, tableName);
  }
  ...
  public void close() {
    ...
    LOGGER.LOG_INFO_MSG("snowflake connection closed");
  }
  ...
  private void removeFile(String stageName, String fileName) {
    ...
    LOGGER.LOG_DEBUG_MSG("deleted {} from stage {}", fileName, stageName);
  }
