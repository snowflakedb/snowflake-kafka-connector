...
public class SnowflakeTelemetryService {
  ...
  public void reportKafkaConnectStart(
    ...
    // Overwrite AUTHENTICATOR_TYPE with the resolved enum.
  ...
  /**
   * Resolves a variable-case, untrimmed string to a standard {@link AuthenticatorType} enum.
   *
   * <p>Never throws: unrecognized values are reported as {@code unknown}.
   */
  private String resolveAuthenticatorType(final Map<String, String> userProvidedConfig) {
    ...
    try {
      ...
      LOGGER.debug("Unrecognized authenticator value; reporting as unknown");
