...
public final class TelemetryConstants {
  ...
  public static final String TOPIC_PARTITION_CHANNEL_CREATION_TIME = "topic_partition_channel_creation_time";
  public static final String TOPIC_PARTITION_CHANNEL_CLOSE_TIME = "topic_partition_channel_close_time";
  //********** ^ Streaming Constants ^ **********//
}
