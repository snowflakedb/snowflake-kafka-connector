 ...
 *   <li>{@code ClosedClientError} - client has been closed and cannot be reused (409 Conflict)
  *   <li>Body-less HTTP 404 - Envoy NR / no-route (empty error payload). T1 also returns this for
  *       an invalid account. Treated as client-invalid: retry the create/recreate burst, then
  *       hourly. A 404 with a Snowflake error detail is a real not-found and is not retried.
 * </ul>
 */
