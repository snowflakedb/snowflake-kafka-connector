 ...
 */
public class SnowpipeBufferThreshold {
  private static final KCLogger LOGGER = new KCLogger(SnowpipeBufferThreshold.class.getName());
   ...
   *     connector config
   */
  public SnowpipeBufferThreshold(
