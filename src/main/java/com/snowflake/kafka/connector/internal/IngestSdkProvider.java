...
public class IngestSdkProvider {
     ...
     *
     * <p>Ideally all ingest sdk calls will go through this to make mocking and integration tests easier to write (potentially also to run most of the integration tests without needing a snowflake connection). Currently it only manages the client.
     */
