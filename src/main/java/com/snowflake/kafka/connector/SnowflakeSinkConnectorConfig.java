...
public class SnowflakeSinkConnectorConfig {
  ...
  // with this flag set to false the user is responsible for creating the destination objects (pipe and the table)
  // when this feature is turned off or on the normal topic to table mapping applies but the connector expects the
  ...
  public static final boolean SNOWPIPE_STREAMING_ENABLE_ALTERING_TARGET_PIPES_AND_TABLES_DEFAULT_VALUE = true;
