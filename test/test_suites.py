...
from test_suit.test_tail_ingestion import TestTailIngestion
...
def create_end_to_end_test_suites(driver, nameSalt, schemaRegistryAddress, testSet):
    ...
    test_suites = OrderedDict([
        ...
        ("TestTailIngestion", EndToEndTestSuite(
            test_instance=TestTailIngestion(driver, nameSalt), clean=True, run_in_confluent=True, run_in_apache=True
        )),
    ])
    return test_suites
