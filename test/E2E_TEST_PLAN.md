...
| Default Pipe Features | 🟢 (4 tests) | 🔴 (preclustering) |
...
| 26 | 🟢 | Default Pipe: Identity column (both modes) | FR7 | Default Pipe | Done |
| 27 | 🟢 | Default Pipe: Default timestamp (both modes) | FR7 | Default Pipe | Done |
