...
public class Enums {
  public enum TestCases {
    JSON_ONE_G_TABLE(Tables.ONE_G_TABLE, Formats.JSON),
    JSON_THREE_HUNDRED_COLUMN_TABLE(Tables.THREE_HUNDRED_COLUMN_TABLE, Formats.JSON),
    AVRO_WITH_SCHEMA_REGISTRY_ONE_G_TABLE(Tables.ONE_G_TABLE, Formats.AVRO_WITH_SCHEMA_REGISTRY),
    AVRO_WITH_SCHEMA_REGISTRY_THREE_HUNDRED_COLUMN_TABLE(
        Tables.THREE_HUNDRED_COLUMN_TABLE, Formats.AVRO_WITH_SCHEMA_REGISTRY),
    AVRO_WITHOUT_SCHEMA_REGISTRY_ONE_G_TABLE(
        Tables.ONE_G_TABLE, Formats.AVRO_WITHOUT_SCHEMA_REGISTRY),
    AVRO_WITHOUT_SCHEMA_REGISTRY_THREE_HUNDRED_COLUMN_TABLE(
        Tables.THREE_HUNDRED_COLUMN_TABLE, Formats.AVRO_WITHOUT_SCHEMA_REGISTRY);
