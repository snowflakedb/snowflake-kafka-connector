...
public abstract class Producer<T> {
  ...
  // abstract elements
  protected abstract KafkaProducer<String, T> getProducer();

  public abstract void send(TestCases testCase);
  ...
  public void send(String topic, T data) {
    getProducer().send(new ProducerRecord<>(topic, nextKeyString(), data));
  }
